...
namespace Tzuk_Asaf.Modules
{
    public class Student : IEntity
    {
        ...
        public DateTime Date_of_birth
        {
            set
            {
                if (ValidationUtilites.GetAge(value) < 16)
                    throw new Exception("Too young to take driving lessons");
        ...
        public string Passed_test
        {
            set
            {
                if (value == "Yes" && this.amount_of_lessons < 28)
                    throw new Exception("Not enough lessons for a test");
